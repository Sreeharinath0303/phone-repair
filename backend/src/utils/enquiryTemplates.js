...
exports.getEnquiryTemplate = (type, data) => {
    ...
    return `
      <div style="${baseStyle}">
        ...
        <div style="background: #f9fafb; padding: 15px; border-left: 4px solid #3b82f6; margin: 20px 0;">
          <p><strong>Message from erepaircafe:</strong></p>
          <p>${responseNotes}</p>
        </div>
        ...
        <br>
        <p>Best regards,<br>The erepaircafe Team</p>
      </div>
    `;
  }
  ...
  return `
    <div style="${baseStyle}">
      ...
      <p>Hello <strong>${name}</strong>,</p>
      <p>Thank you for reaching out to erepaircafe. We have successfully received your <strong>${type.toUpperCase()}</strong> enquiry.</p>
